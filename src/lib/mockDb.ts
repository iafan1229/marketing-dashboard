...
let dashboards: Dashboard[] = [
  {
    id: "dashboard-1",
    name: "대시보드 테스트 1 (3개 타입 차트)",
    charts: ["chart-1", "chart-2", "chart-3"],
    createdAt: "2025-07-01T09:00:00Z",
    updatedAt: "2025-07-30T14:30:00Z",
  },
  {
    id: "dashboard-comprehensive",
    name: "대시보드 테스트 2 (5개 타입 차트)",
    charts: [
      "chart-comp-1",
      "chart-comp-2",
      "chart-comp-3",
...
let charts: Chart[] = [
  ...
  {
    id: "chart-comp-1",
    dashboardId: "dashboard-comprehensive",
    type: "line",
    title: "Orders Over Time",
    dataEndpoint: "/api/data/orders_over_time",
    order: 0,
  ...
  },
  {
    ...
    dataEndpoint: "/api/data/signups_by_region",
    order: 1,
    createdAt: "2025-07-31T10:20:00Z",
    updatedAt: "2025-07-31T14:00:00Z",
  },
  {
    id: "chart-comp-3",
    ...
    dataEndpoint: "/api/data/total_revenue",
    order: 2,
    createdAt: "2025-07-31T10:25:00Z",
    updatedAt: "2025-07-31T14:00:00Z",
  },
  {
    id: "chart-comp-4",
